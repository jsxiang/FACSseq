function hh = herrorbar(x, y, l, u, symbol,colorspec)
...
h = plot(xb,yb,esymbol,'color',colorspec,'linewidth',1.5); hold on
h = [h;plot(x,y,symbol,'color',colorspec,'linewidth',1.5)];
